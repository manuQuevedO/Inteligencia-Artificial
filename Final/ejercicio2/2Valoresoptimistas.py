...
def run(episodes, is_training=True, render=False):
    ...
    q_table_path = r'C:\Users\Manuel\Desktop\Septimo Semestre\Inteligencia Artificial\Final\ejercicio2\puzzle_q_table.pkl'

    # Inicializar la tabla Q con valores optimistas
    if is_training:
        q = np.full((env.observation_space, env.action_space), 10.0)
    else:
    ...
    save_q_table(q, r'C:\Users\Manuel\Desktop\Septimo Semestre\Inteligencia Artificial\Final\ejercicio2\q_table_puzzle.txt')
    ...
    plt.grid(True)
    plt.savefig(r'C:\Users\Manuel\Desktop\Septimo Semestre\Inteligencia Artificial\Final\ejercicio2\puzzle.png')
    plt.show()
