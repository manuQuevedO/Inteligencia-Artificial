...
def run(episodes, is_training=True, render=False, epsilon=0.1):
    ...
    # Inicializar o cargar la Q-table y contador de visitas
    if is_training:
    ...
    for i in range(episodes):
        ...
        while not terminated and rewards > -1000:
            ...
            if is_training:
                ...
                visit_count[state_p, state_v, action] += 1
                alpha = 1 / visit_count[state_p, state_v, action]  # Tasa de aprendizaje incremental

                # Actualización de Q usando la fórmula de acción-valor incremental
                q[state_p, state_v, action] += alpha * (
